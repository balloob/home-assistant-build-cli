...
func init() {
	...
	annotateServiceMutationCommand(todoUncompleteCmd, "write", "todo_item", []string{"args"})
}
...
func runTodoUncomplete(cmd *cobra.Command, args []string) error {
	...
	return callServiceAction("uncomplete", "todo_item", "todo", "update_item", "Item marked incomplete.", map[string]interface{}{
		"entity_id": entityID,
		"item":      uid,
		"status":    "needs_action",
	})
